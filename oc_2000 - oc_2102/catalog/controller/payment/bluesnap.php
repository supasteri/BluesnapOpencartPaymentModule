...
class ControllerPaymentBluesnap extends Controller {
		...
		$data['button_pay_now']	= $this->language->get('button_pay_now');
			...
			$data['bluesnap_fraud_session_id']	= $this->session->data['bluesnap_fraud_session_id'];
                ...
                if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bluesnap_form.tpl')) {
                        $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/bluesnap_form.tpl', $data));
                } else {
                        $this->response->setOutput($this->load->view('default/template/payment/bluesnap_form.tpl', $data));
                }
	}
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bluesnap.tpl')) {
			...
			return $this->load->view('default/template/payment/bluesnap.tpl', $data);
		}
	}
